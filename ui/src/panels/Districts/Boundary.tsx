...
export class PanelBoundary extends Component<BoundaryProps, BoundaryState> {
  ...
  componentDidCatch(error: unknown, info: ErrorInfo): void {
    console.error("[AGORA] Districts panel failed to render", error, info);
  }
      ...
      return (
        <div className={styles.panel}>
          ...
          <div className={styles.boundary}>
            The districts panel stopped rendering. The rest of the interface is unaffected; the
            error is in the game's UI log.
            {this.state.message ? (
