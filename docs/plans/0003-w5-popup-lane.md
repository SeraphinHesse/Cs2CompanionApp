...
- [x] **20b.** **Fix the pre-existing enum leak** at `AgoraUiProjection.cs:1320-1322` —
...
- [x] **20c.** **Consolidate the start-date derivation.** C4 was barred from `AgoraRuntime.cs` and so
